...
function App() {
  ...
  const emergencyStop = async () => {
    try {
      ...
      setError('Error in emergency stop: ' + err.message);
    }
  };
  ...
  const updateStrategy = async () => {
    try {
      ...
      setError('Error updating strategy: ' + err.message);
    }
  };
            ...
            <Card>
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                  {botStatus?.last_analysis && Object.entries(botStatus.last_analysis).map(([symbol, analysis]) => (
